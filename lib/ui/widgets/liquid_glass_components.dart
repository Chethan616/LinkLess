            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                color: isPrimary
                    ? null
                    : (isDark
                          ? ColorPalette.surfaceDark.withOpacity(0.3)
                          : ColorPalette.surfaceLight.withOpacity(0.5)),
              ),
              child: Center(
                child: isLoading
          ...
          child: GlassGlow(
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(
                  color: isDark
                      ? ColorPalette.borderDark.withOpacity(0.3)
                      : ColorPalette.borderLight.withOpacity(0.3),
                  width: 1,
                ),
              ),
              child: child,
    ...
    return LiquidGlass.grouped(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
            color: isDark
                ? ColorPalette.borderDark.withOpacity(0.5)
                : ColorPalette.borderLight.withOpacity(0.5),
            width: 1,
          ),
        ),
        child: Row(
